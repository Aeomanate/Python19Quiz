...
def gen_random_mistake():
    return RegularOption(
        ...
        text=random.choice([
            ...
            'Ты бы победил, если бы игра была наоборот.',
            'Зачем ты это сделал? Просто... зачем?',
            'Уровень IQ: 🥔',
            ...
            'Ты нажал туда, куда никто не должен нажимать.',
